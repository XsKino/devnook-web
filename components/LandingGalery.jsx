...
export default function Galery({ name = '', title, description, pictures }) {
  ...
  return (
    <section id={name.toLowerCase()} className='py-12 px-8 md:py-24 lg:py-32 flex flex-col gap-10'>
      ...
      <div className='grid gap-2 md:gap-4 grid-cols-[repeat(auto-fit,minmax(90px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(200px,1fr))]'>
